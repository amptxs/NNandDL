...
# обучение регрессора sklearn
sklearnModel = MLPRegressor(hidden_layer_sizes=250, activation='logistic',
...
kerasModel.summary()
kerasModelHistory = kerasModel.fit(X_train, y_train, batch_size=25, epochs=100)
...
print(f'MAE sklearn =  {round(mean_absolute_error(y_true=y_test, y_pred=y_pred), 2)}')
